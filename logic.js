...
let content=document.querySelector(".list-text");
let content1=document.querySelector(".list-content");
...
item.addEventListener("click",()=>{
 ...
 content1.innerHTML+=`<li><i class="fa-solid fa-trash" onclick="del(this)"></i><br><b>${text}</b> <p style="font-size:12px ;color:#262626;font-weight:600"><i>Created on:&nbsp;${now}</i></p>
 <p style="font-size:12px ;color:#262626; font-weight:600"><i>Due Date:</i>&nbsp;<span>${text3}</span></p>
 <p style="color:grey;font-size:12px;font-weight:600"><i>${text2}</i></p><br></li>`;
